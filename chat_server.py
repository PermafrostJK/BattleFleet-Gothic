...
# ==============================================================================
                ...
                if msg["message"]=="g":
                    self.ground=Battlefield(4,4,[])
                    self.ground.update_battlefield()
                    ...
                    try:
                        ...
                        #self.ground.attack(clicker)
                        if self.ground.attack(clicker)==False:
                            ...
                            for each in self.ground.battlefield:
                                msg["message"] += str(each)
